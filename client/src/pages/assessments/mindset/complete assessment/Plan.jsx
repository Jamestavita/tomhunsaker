      ...
      <section className="bg-Greyscale200">
        <div className="w-[min(90rem,100%)] mx-auto px-4 md:px-12 lg:px-32 py-16 grid gap-8">
          <p className="text-[44px] lg:text-[56px] font-bold lg:font-medium leading-tight md:w-2/3">
            Mindset & Culture are the foundation to effectiveness
          </p>
          <div className="grid gap-6 lg:w-3/5">
            <p className="text-[18px] font-bold">
              Mindset drives action quality. Culture facilitates or inhibits the
              speed and effectiveness with which signals travel within an
              organization — it is the transmission mechanism between
              organizational thought to action and back again.
            </p>
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr,0.5fr]">
            <div className="bg-Greyscale grid gap-6 rounded-[40px] p-6 text-Greyscale900">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop offset="0.0327056" stopColor="#CB4A22" />
                        <stop offset="0.520187" stopColor="#F9E3DC" />
                        <stop offset="0.960352" stopColor="#CB4A22" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        ...
                        <stop offset="0.546875" stopColor="#CB4A22" />
                        <stop offset="1" stopColor="#CB4A22" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        <stop stopColor="#CB4A22" />
                        <stop offset="0.526042" stopColor="#F9E3DC" />
                        <stop offset="1" stopColor="#CB4A22" />
                      </linearGradient>
                      <linearGradient
                      ...
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop offset="0.0277705" stopColor="#CB4A22" />
                        <stop
                          offset="0.723618"
                          stopColor="#EDAB96"
                          stopOpacity="0"
                  ...
                  >
                    ...
                    <defs>
                      ...
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop stopColor="#F9E3DC" />
                        <stop offset="0.765625" stopColor="#CB4A22" />
                      </linearGradient>
                      <linearGradient
                ...
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <path
                      ...
                      strokeWidth="0.271186"
                    />
                    <g clipPath="url(#clip0_804_133574)">
                    ...
                    <defs>
                      ...
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop offset="0.0207592" stopColor="#F9E3DC" />
                        <stop offset="0.649494" stopColor="#CB4A22" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        <stop stopColor="#CB4A22" />
                        <stop offset="1" stopColor="#F9E3DC" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        <stop stopColor="#F9E3DC" />
                        <stop offset="0.586318" stopColor="#CB4A22" />
                        <stop
                          offset="1"
                          stopColor="#CB4A22"
                          stopOpacity="0.17"
                ...
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <g filter="url(#filter0_d_804_133577)">
                      <g clipPath="url(#clip0_804_133577)">
                        <rect
                          x="8"
                          y="12"
                          width="52"
                        ...
                        <circle
                          ...
                          r="16.6372"
                          stroke="#1C1C1C"
                          strokeWidth="0.0937306"
                          strokeDasharray="0.19 0.19"
                        />
                        <circle
                          cx="34.0812"
                          cy="55.5831"
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#CB4A22" />
                        <stop offset="1" stopColor="#9D391A" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        <stop offset="0.474504" stopColor="#CB4A22" />
                        <stop offset="1" stopColor="#9D391A" />
                      </radialGradient>
                      <radialGradient
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <stop
                          ...
                          stopOpacity="0.7"
                        />
                        <stop offset="1" stopColor="#CB4A22" stopOpacity="0" />
                      </linearGradient>
                      <radialGradient
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        ...
                        />
                        <stop offset="1" stopColor="#F9E3DC" />
                        <stop offset="1" stopColor="#F9E3DC" stopOpacity="0" />
                      </linearGradient>
                    </defs>
                  </svg>
                  <p className="">
                ...
                <AppButton100
                  ...
                  className="bg-Red500 text-Greyscale mt-4 border-Red500 border-2"
                  onClick={() => navigate("../assessment/mindset/paid")}
                />
              </div>
            </div>
            <div className="bg-Greyscale grid gap-6 rounded-[40px] p-6 text-Greyscale900 justify-center md:grid-cols-2 lg:grid-cols-1">
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="md:-mb-6 md:mt-6 lg:my-0 lg:mx-auto"
              >
                <path
              ...
              <AppButton100
                ...
                className="border-2 border-Red500 text-Red500 my-auto"
                onClick={() => navigate("../assessment/mindset/free")}
              />
            </div>
          </div>
        </div>
