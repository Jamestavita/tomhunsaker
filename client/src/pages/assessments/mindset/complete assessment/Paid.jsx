...
export default function Paid() {
  ...
  return (
    <div className="bg-Greyscale200 mx-auto">
      <div className="w-[min(90rem,100%)] mx-auto md:px-12 lg:px-32 pb-16 md:pt-16 lg:pb-24 grid gap-12 lg:grid-cols-[1fr,0.7fr]">
        <form
          // onSubmit={onSubmitForm}
          id=""
          className="grid gap-10 py-12 md:py-10 px-6 md:px-10 bg-Greyscale rounded-[20px]"
        >
