      ...
      <section className="bg-Greyscale200">
        <div className="w-[min(90rem,100%)] mx-auto px-4 md:px-12 lg:px-32 py-16 grid gap-8">
          <p className="text-[44px] lg:text-[56px] font-bold lg:font-medium leading-tight md:w-2/3">
            Drive innovation in any conditions
          </p>
          <div className="grid gap-6 lg:w-3/5">
            <p className="text-[18px] font-bold">
              Effective innovation BRIDGERS scout and validate ideas that others
              miss and win their adoption when others can't.
            </p>
            <p className="text-[18px]">
              Organizations that build a cadre of BRIDGERS and create systems to
              support them have the growth advantage.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr,0.5fr]">
            <div className="bg-Greyscale grid gap-6 rounded-[40px] p-6 text-Greyscale900">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop offset="0.0327056" stopColor="#315C90" />
                        <stop offset="0.520187" stopColor="#D9E4F1" />
                        <stop offset="1" stopColor="#315C90" />
                      </linearGradient>
                      <linearGradient
                      ...
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop stopColor="#315C90" />
                        <stop offset="0.526042" stopColor="#85A9D5" />
                        <stop offset="1" stopColor="#315C90" />
                      </linearGradient>
                      <linearGradient
                ...
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <path
                      ...
                      strokeWidth="0.271186"
                    />
                    <g clipPath="url(#clip0_804_137664)">
                    ...
                    <defs>
                      ...
                      <linearGradient
                        ...
                        gradientUnits="userSpaceOnUse"
                      >
                        <stop offset="0.0207592" stopColor="#D9E4F1" />
                        <stop offset="0.649494" stopColor="#315C90" />
                      </linearGradient>
                      <linearGradient
                      ...
                      >
                        <stop stopColor="#D9E4F1" />
                        <stop offset="0.586318" stopColor="#315C90" />
                        <stop offset="1" stopColor="#D9E4F1" />
                      </linearGradient>
                      <radialGradient
                ...
                <div className="flex gap-4 items-center [&>*:first-child]:shrink-0">
                  ...
                  >
                    ...
                    <g filter="url(#filter1_d_804_137667)">
                      <g clipPath="url(#clip0_804_137667)">
                        <rect
                          x="8"
                          y="12"
                          width="52"
                    ...
                    <defs>
                      ...
                      >
                        <stop offset="0.474504" stopColor="#315C90" />
                        <stop offset="1" stopColor="#213C5F" />
                      </radialGradient>
                      <linearGradient
                ...
                <AppButton100
                  ...
                  className="bg-Blue500 text-Greyscale mt-4 border-Blue500 border-2"
                  onClick={() => navigate("../assessment/innovation/paid")}
                />
              </div>
            </div>
            <div className="bg-Greyscale grid gap-6 rounded-[40px] p-6 text-Greyscale900 justify-center md:grid-cols-2 lg:grid-cols-1">
              ...
              <AppButton100
                ...
                className="border-2 border-Blue500 text-Blue500 my-auto"
                onClick={() => navigate("../assessment/innovation/free")}
              />
            </div>
          </div>
        </div>
