...
export default function FifteenToTwentyFour() {
  ...
  return (
    <div className="">
      <div className="grid lg:flex gap-2 items-center w-[min(90rem,100%)] mx-auto p-4 md:px-12 lg:px-32 lg:justify-between">
        <p className="text-[24px] text-center lg:text-left font-bold w-[min(340px,100%)] md:w-full lg:w-[min(370px,100%)] mx-auto lg:mx-0">
          The following question relates to you{" "}
          <span className="text-Blue500">interpersonally</span>
        </p>
      ...
      <div className="overflow-hidden relative grid px-4 md:px-12 lg:px-32">
        ...
        <div className="grid gap-12 w-[min(703px,100%)] mx-auto my-5 z-[1]">
          ...
          <AppNextButton
            onClick={() =>
              navigate(
                number_interpersonal < 24
                  ? `../assessment/innovation/interpersonal/${
                      +number_interpersonal + 1
                    }`
                  : `../assessment/innovation/team/${+number_interpersonal + 1}`
              )
            }
