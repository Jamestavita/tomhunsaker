            ...
            <div className="grid gap-4 w-full md:w-4/6 md:mx-0 text-left">
              <div className="flex gap-4 items-center">
                ...
                <p className="text-[18px]">
                  Your complete Execution & Agility AMPLIFIER score
                </p>
              </div>
              <div className="flex gap-4 items-center">
                <IoMdCheckmarkCircleOutline className="shrink-0 text-3xl" />
              ...
              <div className="flex gap-4 items-center">
                <IoMdCheckmarkCircleOutline className="shrink-0 text-3xl" />
                <p className="text-[18px]">
                  A digital copy of the leading abridged book AMPLIFIER by Dr.
                  Tom Hunsaker
                </p>
              </div>
              <div className="flex gap-4 items-center">
          ...
          <div className="mt-10 lg:mt-0 relative grid lg:ml-auto lg:w-2/3 self-center">
            <div className="grid w-[min(26rem,100%)] mx-auto md:mx-0 relative">
              ...
              <div className="w-[90%] mx-auto h-[270px] md:h-[340px] bg-Greyscale absolute z-[1] -translate-x-[50%] left-1/2 p-5 top-5">
                <div className="h-[131%] w-[100%] mx-auto bg-Greyscale rounded-full relative grid place-items-center border border-Yellow500">
                  <div className="h-[95%] w-[95%] -translate-x-[50%] -translate-y-[50%] top-1/2 left-1/2 bg-Yellow500 rounded-full absolute text-center">
