            ...
            <div className="w-[214px] lg:w-[190px] mx-auto grid gap-[0_20px] place-items-center relative grid-cols-2 p-7 lg:p-4">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stopColor="#EF3C23" stopOpacity="0.09" />
                    <stop offset="0.447036" stopColor="#EF3C23" />
                    <stop offset="1" stopColor="#EF3C23" stopOpacity="0.62" />
                  </linearGradient>
                  <linearGradient
            ...
            <div className="w-[214px] lg:w-[190px] mx-auto grid gap-5 place-items-center relative p-[15.5px] lg:p-1">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop offset="0.659316" stopColor="white" stopOpacity="0" />
                  ...
                  >
                    ...
                    <stop offset="0.109375" stopColor="#CB4A22" />
                    <stop
                      offset="0.28125"
                      stopColor="#CB4A22"
                      stopOpacity="0"
          ...
          <div className="grid gap-4 p-6 lg:p-4 rounded-[40px] bg-Greyscale">
            <div className="w-[214px] lg:w-[190px] mx-auto grid gap-5 place-items-center relative py-[22px] lg:p-0">
              ...
              <svg
                ...
                fill="none"
              >
                <g clipPath="url(#clip0_124_28650)">
                  <g opacity="0.7">
                    <rect
                      x="0.881836"
                      y="0.237793"
                ...
                <defs>
                  ...
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop stopColor="#CB4A22" stopOpacity="0" />
                    <stop offset="1" stopColor="#CB4A22" />
                  </linearGradient>
                  <linearGradient
      ...
      <div className="">
        ...
        <div className="grid justify-center md:justify-start md:grid-cols-2 lg:grid-cols-3 md:w-fit">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_548_22035)">
              <path
