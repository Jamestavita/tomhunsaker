...
import Strategy_Change from "../../assets/concepts pdfs/Strategy & Change.pdf";
      ...
      <div className="grid lg:grid-cols-[0.7fr,1fr] gap-[56px] md:gap-[64px] lg:gap-5 items-start">
        <div className="grid gap-10 lg:gap-16">
          ...
          <div className="grid gap-4 lg:gap-2 md:grid-cols-2 lg:grid">
            <a
              href={Strategy_Change}
              download
              className={`py-3 rounded-[32px] font-bold flex gap-1 items-center justify-center bg-Greyscale border-[1px] border-Green700 text-Green700 lg:text-sm`}
            >
              <svg
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-3">
          ...
          <div className="grid rounded-[40px] bg-Greyscale pt-1">
            ...
            <div className="px-4 pb-5">
              ...
              <p className="lg:text-sm">Determine Fit-to-Purpose®</p>
            </div>
          </div>
          <div className="grid rounded-[40px] bg-Greyscale pt-1">
            <div className="mx-auto grid gap-5 place-items-center relative">
          ...
          <div className="grid rounded-[40px] bg-Greyscale pt-1">
            ...
            <div className="px-4 pb-5">
              ...
              <p className="lg:text-sm">Pave the Path</p>
            </div>
          </div>
        </div>
      </div>
